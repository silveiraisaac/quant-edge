...
function cellStyle(value: number) {
  ...
  return value >= 0
    ? { backgroundColor: `rgba(8, 127, 91, ${0.08 + strength * 0.22})`, color: strength > 0.72 ? "#04553c" : "#087f5b" }
    : { backgroundColor: `rgba(199, 62, 77, ${0.08 + strength * 0.22})`, color: strength > 0.72 ? "#922332" : "#b53040" };
}
